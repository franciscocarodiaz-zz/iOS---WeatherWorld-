...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@. %@-%@", city.name, city.latitude, city.longitude];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchRequest *fetchRequest = [City allCountersFetchRequestInContext:self.managedObjectContext];
